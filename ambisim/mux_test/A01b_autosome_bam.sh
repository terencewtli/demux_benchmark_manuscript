...
GEX_HEADER=$PROJDIR/ambient/ambisim/cov_mux_test/header/auto_gex_header.sam
ATAC_HEADER=$PROJDIR/ambient/ambisim/cov_mux_test/header/auto_atac_header.sam
