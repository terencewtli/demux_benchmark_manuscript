...
INDIR=$PROJDIR/ambient/ambisim/prop_doub/$EXP
cd $INDIR
...
GEX_HEADER=$PROJDIR/ambient/ambisim/prop_doub/header/auto_gex_header.sam
ATAC_HEADER=$PROJDIR/ambient/ambisim/prop_doub/header/auto_atac_header.sam
